...
class MultiVAETorch_void(MultiVAETorch_smaller):
...
class MultiVAE_void(MultiVAE_smaller):
    def __init__(
        self,
        adatas,
        names,
        ...
        self.model = MultiVAETorch_void(self.encoders, self.decoders, self.shared_encoder, self.shared_decoder,
    ...
    def test(self,
        ...
        with torch.no_grad():
            ...
            for datas in zip_longest(*dataloaders):
                ...
                for i, (z_latent, pair) in enumerate(zip(zs_latent, new_pair_groups)):
                    z = self.model.convert(z_latent, pair, True, None)
